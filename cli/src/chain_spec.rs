...
use node_runtime::{
    AssetsConfig, AssetsQueryConfig, AuthorityDiscoveryConfig, BTCBridgeConfig, BabeConfig,
    BalancesConfig, BridgeConfig, ContractsConfig, CouncilConfig, DemocracyConfig, GrandpaConfig,
    ImOnlineConfig, IndicesConfig, DepositLoanConfig, SessionConfig, SessionKeys,
...
const DEFAULT_PROPERTIES: &str = r#"
{
"tokenSymbol": "DFX",
"tokenDecimals": 8
}
...
pub fn staging_testnet_config() -> ChainSpec {
    ...
    ChainSpec::from_genesis(
        ...
        None,
        Some(json::from_str(DEFAULT_PROPERTIES).unwrap()),
        Default::default(),
    )
}
...
pub fn testnet_genesis(
    ...
    GenesisConfig {
        ...
        pallet_collective_Instance1: Some(CouncilConfig {
            members: endowed_accounts.iter().cloned().collect::<Vec<_>>()
                [..(num_endowed_accounts + 1) / 2]
                .to_vec(),
        ...
        pallet_generic_asset: Some(AssetsQueryConfig {
            next_asset_id: 9,
            staking_asset_id: 0,
            spending_asset_id: 0,
            assets: vec![],
        ...
        assets: Some(AssetsConfig {
            symbols: vec![
                (1, "SBTC".as_bytes().to_vec()),
                (2, "DFTAX".as_bytes().to_vec()),
                (3, "DFXP1".as_bytes().to_vec()),
                (4, "DFXP2".as_bytes().to_vec()),
                (5, "DFXP3".as_bytes().to_vec()),
                (6, "DFXP4".as_bytes().to_vec()),
                (7, "DFXP5".as_bytes().to_vec()),
                (8, "DFS".as_bytes().to_vec()),
            ],
        }),
        deposit_loan: Some(DepositLoanConfig {
            dtoken_asset_id: 5,
            market_dtoken_asset_id:6,
            total_dtoken_asset_id:7,
            ...
            total_dtoken_account_id: get_account_id_from_seed::<sr25519::Public>("88886666"),
            market_dtoken_account_id: get_account_id_from_seed::<sr25519::Public>("66668888"),
            penalty_rate: 200,
