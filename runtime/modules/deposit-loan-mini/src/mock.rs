...
pub mod constants {
    ...
    pub const DAVE: <Test as frame_system::Trait>::AccountId = 5;
}
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    let market_dtoken_account_id: <Test as system::Trait>::AccountId = get_from_seed::<sr25519::Public>("market_dtoken_account_id");
    let total_dtoken_account_id: <Test as system::Trait>::AccountId = get_from_seed::<sr25519::Public>("total_dtoken_account_id");
    let collection_account_id: <Test as system::Trait>::AccountId = get_from_seed::<sr25519::Public>("collection_account_id");
    let profit_pool: <Test as system::Trait>::AccountId = get_from_seed::<sr25519::Public>("profit_pool");
    let pawn_shop: <Test as system::Trait>::AccountId = get_from_seed::<sr25519::Public>("pawn_shop");
    let liquidation_account: <Test as system::Trait>::AccountId = get_from_seed::<sr25519::Public>("liquidation_account");
